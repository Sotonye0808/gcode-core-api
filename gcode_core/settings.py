"""
Django settings for the GCode Core API.

This service handles data persistence, user management, and SVG conversion.
It's designed to be lightweight without heavy image processing dependencies.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-core-api-change-in-production')
...
MIDDLEWARE = [
    ...
    'core_api.middleware.CustomCORSMiddleware',
...
WSGI_APPLICATION = 'gcode_core.wsgi.application'
...
# Evaluation API URL (for communication with evaluation service)
EVALUATION_API_URL = os.getenv('EVALUATION_API_URL', 'http://localhost:8001/api/')
