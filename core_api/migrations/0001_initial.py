# Generated by Django 4.2.7 on 2025-08-02 19:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(help_text='User who submitted this signature', on_delete=django.db.models.deletion.CASCADE, related_name='signatures', to='core_api.user')),
            ],
            options={
